...
1. **Scan images:** Use `rg --files`, `find`, or available file search tools to find images in the directory (`images/*.{png,jpg,jpeg,gif,svg}`)
2. **Recognize content:** Use available image inspection tools to view each image and understand what it contains
...
다음 단계: export reference를 사용해 HTML 생성 진행
